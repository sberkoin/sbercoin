Contributing to SBER Core
============================

The SBER Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/sber-project/sber/blob/master/doc/translation_process.md)
...
The following applies to code changes to the SBER Core project, and is not to be
confused with overall SBER Network Protocol consensus changes.

Whether a pull request is merged into SBER Core rests with the project merge
...
Patches that change SBER consensus rules are considerably more involved than
...
Where a patchset proposes to change the SBER consensus, it must have been
...
The project leader is the release manager for each SBER Core release.
