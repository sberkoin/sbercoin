...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            SBERGUI* window = static_cast<SBERGUI*>(parentWidget());
...
{
    SBERGUI* gui = static_cast<SBERGUI*>(parentWidget());
...
{
    hide();
    static_cast<SBERGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("SBER will close now to finish the encryption process. "
