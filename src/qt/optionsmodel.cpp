...
void OptionsModel::setDisplayDefaultOptions(QSettings& settings, bool reset)
{
    ...
    if (settings.contains("nAnonymizeSberAmount") || reset)
        gArgs.SoftSetArg("-anonymizesberamount", settings.value("nAnonymizeSberAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in sber.cpp during shotdown to also remove the window positions
