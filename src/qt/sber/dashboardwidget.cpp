...
#include "qt/sber/forms/ui_dashboardwidget.h"
#include "qt/sber/sendconfirmdialog.h"
#include "qt/sber/txrow.h"
...
DashboardWidget::DashboardWidget(SBERGUI* parent) :
    PWidget(parent),
...
bool hasCharts = false;
    ...
    if (window)
        connect(window, &SBERGUI::windowResizeEvent, this, &DashboardWidget::windowResizeEvent);
#endif
