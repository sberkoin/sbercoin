...
#include "qt/sber/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/sber/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(SBERGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    if (parent)
        connect(parent, &SBERGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
