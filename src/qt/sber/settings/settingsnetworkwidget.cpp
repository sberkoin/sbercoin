...
#include "qt/sber/settings/settingsnetworkwidget.h"
#include "qt/sber/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/sber/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(SBERGUI* _window, QWidget *parent) :
