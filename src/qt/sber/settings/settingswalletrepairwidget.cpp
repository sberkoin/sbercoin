...
#include "qt/sber/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/sber/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(SBERGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to SBERGUI::handleRestart()
