...
#include "qt/sber/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(SBERGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("SBER_tx_csv_export(*.csv)") : tr("SBER_addresses_csv_export(*.csv)"),
                                        nullptr);
