...
#include "qt/sber/forms/ui_addresseswidget.h"
#include "qt/sber/addresslabelrow.h"
#include "qt/sber/addnewaddressdialog.h"
...
AddressesWidget::AddressesWidget(SBERGUI* parent) :
    PWidget(parent),
