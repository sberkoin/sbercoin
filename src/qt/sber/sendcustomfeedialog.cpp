...
#include "qt/sber/sendcustomfeedialog.h"
#include "qt/sber/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(SBERGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &SBERGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
