...
#include "qt/sber/furabstractlistitemdelegate.h"
#include "qt/sber/txviewholder.h"
#include "qt/sber/tooltipmenu.h"
#include "qt/sber/sendmultirow.h"
#include "qt/sber/coldstakingmodel.h"
#include "qt/sber/contactsdropdown.h"
#include "qt/sber/addressholder.h"
...
public:
    explicit ColdStakingWidget(SBERGUI* parent);
    ~ColdStakingWidget();
