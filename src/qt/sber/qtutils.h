...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, SBERGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, SBERGUI* gui, double posX = 3);
