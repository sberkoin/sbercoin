...
// Copyright (c) 2016-2020 The SBER developers
...
public:
    ...
    /**
     * Amount of sber coming in to a transaction
...
// SBER: It assumes that overwrites are never possible due to BIP34 always in effect
