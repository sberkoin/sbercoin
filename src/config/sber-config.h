/* src/config/sber-config.h.  Generated from sber-config.h.in by configure.  */
/* src/config/sber-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://github.com/sber-project/sber/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "SBER Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "SBER Core 4.3.99"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "sber"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://sber.org/"

/* Define to the version of this package. */
#define PACKAGE_VERSION "4.3.99"
