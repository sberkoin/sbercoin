...
extern const char * const SBER_CONF_FILENAME;
extern const char * const SBER_PID_FILENAME;
extern const char * const SBER_MASTERNODE_CONF_FILENAME;
...
{
    std::string s = strprintf("sber-%s", name);
