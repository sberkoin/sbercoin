...
1. Clone the SBER Core source code:

        git clone https://github.com/sber-project/sber
        cd sber
...
SBER Core is now available at `./src/sberd`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/SBER"

    touch "/Users/${USER}/Library/Application Support/SBER/sber.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/SBER/sber.conf"

The first time you run sberd, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.

You can monitor the download process by looking at the debug.log file:

    tail -f $HOME/Library/Application\ Support/SBER/debug.log

Other commands:
-------

    ./src/sberd -daemon # Starts the sber daemon.
    ./src/sber-cli --help # Outputs a list of command-line options.
    ./src/sber-cli help # Outputs a list of RPC commands when the daemon is running.
