...
The build script we'll be using is contained in the SBER github repository ([contrib/gitian-build.py](https://github.com/sber-project/sber/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the SBER repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/SBER-Project/SBER/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, sber-detached-sigs, and sber GitHub repos.
