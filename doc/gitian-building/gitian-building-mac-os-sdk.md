...
The script [extract-osx-sdk.sh](https://github.com/sber-project/sber/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
sber/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/sber-project/sber/blob/master/doc/README_osx.md) for troubleshooting tips.