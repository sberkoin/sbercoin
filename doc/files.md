...
sber.conf           | contains configuration settings for sberd or sber-qt
sberd.pid           | stores the process id of sberd while running
...
debug.log           | contains debug information and general logging generated by sberd or sber-qt
