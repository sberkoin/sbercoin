...
class BudgetProposalTest(SberTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test with invalid SBER address")
        assert_raises_rpc_error(-5, "Invalid SBER address", self.nodes[0].preparebudget,
