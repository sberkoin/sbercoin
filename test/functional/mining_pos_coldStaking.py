...
from test_framework.sber_node import SberTestNode
...
class SBER_ColdStakingTest(SberTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(SberTestNode())
