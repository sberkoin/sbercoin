...
from test_framework.test_framework import SberTier2TestFramework
...
class MasternodeGovernanceBasicTest(SberTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposalLink = "https://forum.sber.org/t/test-proposal"
