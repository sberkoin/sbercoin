...
"""Verify that starting sber with -h works as expected."""
import subprocess

from test_framework.test_framework import SberTestFramework
from test_framework.util import assert_equal

class HelpTest(SberTestFramework):
    ...
    def run_test(self):
        self.log.info("Start sber with -? for help text")
        ...
        self.log.info("Start sber with -version for version information")
