...
This means one can have an always-on sberd instance running, and another local sberd/sber-qt instance which connects to this node and receives blocks from it.
