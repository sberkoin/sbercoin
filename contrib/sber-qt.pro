...
RESOURCES += src/qt/sber.qrc src/qt/sber_locale.qrc

TRANSLATIONS += src/qt/locale/sber_bg.ts \
                src/qt/locale/sber_de.ts \
                src/qt/locale/sber_en.ts \
                src/qt/locale/sber_es.ts \
                src/qt/locale/sber_fi.ts \
                src/qt/locale/sber_fr.ts \
                src/qt/locale/sber_it.ts \
                src/qt/locale/sber_ja.ts \
                src/qt/locale/sber_pl.ts \
                src/qt/locale/sber_pt.ts \
                src/qt/locale/sber_ru.ts \
                src/qt/locale/sber_sk.ts \
                src/qt/locale/sber_sv.ts \
                src/qt/locale/sber_vi.ts \
                src/qt/locale/sber_zh_CN.ts \
                src/qt/locale/sber_zh_TW.ts
